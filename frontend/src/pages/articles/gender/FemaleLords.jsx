          ...
          <div className="female-lords-card">
            <div className="female-lords-detail">
              ...
              <p>
                ...
                constraints in the game’s script so it’s difficult to
                ...
                than Celica in the remake, Echoes. So even if Celica is
                technically featured more in Gaiden’s story, Alm clearly wins
                out as the top-billed lord in the modern version of the story.
              </p>
              <p>
                ...
                facing directly, forwards, where Celica is partially hidden and
                to the side of Alm. Celica does receive a bigger feature in the
                Echoes artwork, as she is placed back-to-back with Alm, but she
                still takes up less over the cover space and is placed more
                off-center.
              </p>
          ...
          <div className="female-lords-card">
            <div className="female-lords-detail">
              ...
              <p>
                ...
                known as Lyn Mode, her story is set before the rest of the main
        ...
        <section className="female-lords-item">
          <div className="female-lords-card">
            <div className="female-lords-detail">
              ...
              <p>
                Micaiah is introduced as the main lord of Radiant Dawn, the
                second game in the Tellius duology. While she and Ike, the main
                lord of FE9, are prominently featured throughout the game’s
                story, Micaiah receives 90 more spoken lines, is the first
                character introduced to the character, and effectively initiates
                the inciting incident of the whole story. Additionally, she is
                the most prominently featured character on the game’s cover,
                placed in the center without being obscured, while Ike is not
                featured at all.
              </p>
        ...
        <section className="female-lords-item">
          <div className="female-lords-card">
            <div className="female-lords-detail">
              ...
              <p>
                Lucina is one of three featured lords in Awakening, the other
                two being her father, Chrom, and the avatar, Robin. She receives
                significantly less lines than the other two, having only a fifth
                of the total number of lines belonging to Chrom. However, she
                does receive a heavy spotlight in the promotational material of
                the game, being featured on the Awakening game poster at equal
                ...
                and Fire Emblem: Engage). That being said, in her own game, she
                is nowhere near being the top billed lord.
              </p>
              <h5>
        ...
        <section className="female-lords-item">
          <div className="female-lords-card">
            <div className="female-lords-detail">
              ...
              <p>
                Three Houses has a unique narrative structure: the player
                follows the story of Byleth, the main avatar character, who
                chooses one of three lords to follow. Edelgard is the only
                female option of the three lords, and while she plays a massive
                role in the game’s narrative, inciting the events in the second
                half of the game, she is actually still shafted by the writers.
                Edelgard has the least amount of lines of all four lords in
                Three Houses, and her personal route is 3-4 chapters shorter
                than every other route in the game while also not featuring a
                unique final battle theme; additionally, she is the only lord
                who the players are given the option to abandon even after
                initially choosing her route. In promotional material, however,
                she is displayed with equal prominence to the rest of the lords.
              </p>
              <h5>
