...
import "./gender.css";
import TransitionsFull from "../../../visualizations/gender/TransitionsFull";

function TransitionsFullPage() {
  ...
  return (
    <VizWrapper color={getColor("gender")} navColor={"#123622"}>
      <div className="article gender-page gendertransitions">
        <h1>Transitions Across the Series</h1>
        <p>
...
export default TransitionsFullPage;
