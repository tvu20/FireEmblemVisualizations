    ...
    <VizWrapper color={getColor("script")} navColor={"#3b2708"}>
      <div className="article script-page complexity-words">
        ...
        <p>
          ...
          visualizes the language complexity metrics of the Fire Emblem game
          transcripts, compared with a variety of other compiled written texts.
          <br />
          <br />
          ...
          colors being further separated from Fire Emblem games and cooler
          colors being more similar in medium form. The closest type of media
          displayed in this graph is other strategy role-playing games, which
          inhabit the same video game genre that Fire Emblem does.
          <br />
          <br />
          ...
          We can see that all the Fire Emblem games have relatively similar
          language complexity metrics, and share similar values with other types
          of video games and scripts.
        </p>
      </div>
    </VizWrapper>
  );
